...
exp_name=finetune_"$data_parallel"_mp"$mp"_bsz2_accum_4_gpu8_lr_00002_warmup1_epoch3_max_len512_gorilla_tensorflow_consolidate
...
--max_words 512 --data_config configs/finetune/gorilla_tf.yaml --llama_tokenizer_path "$llama_path"/tokenizer.model \
